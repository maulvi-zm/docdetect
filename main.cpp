...
Mat debugSquares( std::vector<std::vector<Point> > squares, Mat image )
{
    for ( int i = 0; i< squares.size(); i++ ) {
        // draw contour
        drawContours(image, squares, i, Scalar(255,0,0), 1, 8, std::vector<Vec4i>(), 0, Point());
...
int main(){
    Mat image = imread("2.jpeg");  // Replace with the actual path to your image
